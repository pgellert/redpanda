...
static inline bool config_property_requested(
...
template<typename T>
static inline void add_config_if_requested(
...
static inline void add_broker_config(
  describe_configs_result& result,
  std::string_view name,
...
template<typename T, typename Func>
static inline void add_broker_config_if_requested(
  const describe_configs_resource& resource,
  describe_configs_result& result,
  std::string_view name,
  const config::property<T>& property,
...
template<typename T, typename Func>
static inline void add_topic_config(
  describe_configs_result& result,
...
template<typename T, typename Func>
static inline void add_topic_config_if_requested(
  const describe_configs_resource& resource,
  describe_configs_result& result,
  std::string_view default_name,
  const T& default_value,
...
static inline ss::sstring kafka_authn_endpoint_format(
