...
class ListKafkaConnectionsRequest(google.protobuf.message.Message):
    ...
    def __init__(self, *, node_id: builtins.int | None=..., page_size: builtins.int=..., filter: builtins.str=..., order_by: builtins.str=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['_node_id', b'_node_id', 'node_id', b'node_id']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['_node_id', b'_node_id', 'filter', b'filter', 'node_id', b'node_id', 'order_by', b'order_by', 'page_size', b'page_size']) -> None:
        ...
...
class ListKafkaConnectionsResponse(google.protobuf.message.Message):
    """ListKafkaConnectionsRequest is the response from the ListKafkaConnections
    RPC.
    """
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
