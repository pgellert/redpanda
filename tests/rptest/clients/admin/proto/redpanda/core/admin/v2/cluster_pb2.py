...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_LISTKAFKACONNECTIONSREQUEST']._serialized_end = 318
    _globals['_LISTKAFKACONNECTIONSRESPONSE']._serialized_start = 320
    _globals['_LISTKAFKACONNECTIONSRESPONSE']._serialized_end = 432
    _globals['_CLUSTERSERVICE']._serialized_start = 435
    _globals['_CLUSTERSERVICE']._serialized_end = 591